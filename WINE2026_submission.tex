...
$g$ and liquidity $\theta$ ($N$ is the number of strategic solvers and $\alpha$ is
...
Thus $g$ caps how much batching amplifies standalone value. The case $g=1$ is
additive.
\end{definition}
...
nonempty. The separation is driven by overlap, as in the integrality gap.
\end{proposition}
...
and each agent demanding a profit-maximizing collection, pays
