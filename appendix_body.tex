...
fixed-parameter tractability, UDP contracts each directed pair to an
atomic item. After fair filtering, every surviving bid is a weighted
subset of the $P$ atoms, and winner determination is weighted set packing
on a universe of size $P$. The dynamic program
