...
option. Independent geometric prices make the solver choose only the
cheapest acceptable option: $D=P_{\min}$ if $P_{\min}\le g$, and $D=0$
otherwise. Hence
\[
...
\begin{table}[h]
\centering
\caption{Deployment diagnostics used only as motivation. The visible
