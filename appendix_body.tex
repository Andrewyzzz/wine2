...
$\gamma=V/C_S\in[1,g]$, and deficit
$D=\sum_{j\in S}(c_j-y_j)^+$. Two fair uses:
...
$y_1=(\gamma^\ast-\alpha)c$, $\gamma^\ast=\min(g,\Gamma)$. Repairing
...
feasible because any demanded $S$ has $V_S\ge C_St\ge C_S$, so posted
delivery clears its floors. Let
\[
p(t)=
